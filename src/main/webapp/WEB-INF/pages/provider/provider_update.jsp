           ...
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/update">
			<input type="hidden" name="id" value="${provider.id}">
                ...
                <div class="">
                    ...
                    <input type="text" name="proCode" id="proCode" value="${provider.proCode}" readonly>
					<!-- 放置提示信息 -->
					<font color="red"></font>
                </div>
                <div>
                    <label for="proName">供应商名称：</label>
                   <input type="text" name="proName" id="proName" value="${provider.proName}" readonly>
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="proFax" id="proFax" value="${provider.proFax}" readonly>
                </div>
                <div>
                    <label for="proDesc">描述：</label>
                    <input type="text" name="proDesc" id="proDesc" value="${provider.proDesc}" readonly>
                </div>
